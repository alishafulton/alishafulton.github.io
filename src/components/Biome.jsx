    ...
    <div class=" flex flex-col w-full lg:w-3/4 items-center rounded-2xl pt-16 ">
        ...
        <div class="flex flex-col bg-midnight/10 rounded-xl w-full text-midnight pt-12 items-center font-outfit text-midnight overflow-hidden">
            ...
            <motion.div 
                ...
                <div class="w-full h-full px-2 lg:px-10 flex flex-col items-center gap-4 ">

                    <div class="flex w-3/4 gap-2 lg:gap-4">
                        <div class="bg-midnight/30 rounded-lg flex px-2 lg:px-4 w-full items-center p-2 space-x-2">
                            <div class="text-4xl md:text-6xl text-white opacity-60">01</div>
                            <div class="text-[10px] font-outfit-light">I am stressed that my new facility will not meet my career needs.</div>
                        </div>

                        <div class="bg-midnight/30 rounded-lg flex px-2 lg:px-4 w-full items-center p-2 space-x-2">
                            <div class="text-4xl md:text-6xl text-white opacity-60">02</div>
                            <div class="text-[10px] font-outfit-light ">I don’t want to spend all of my free time networking and researching.</div>
                        </div>
                    </div>

                    <div class="flex w-full gap-2 lg:gap-4">
                        <div class="bg-midnight/30 rounded-lg flex px-2 lg:px-4 w-full items-center p-2 space-x-2">
                            <div class="text-4xl md:text-6xl text-white opacity-60">03</div>
                            <div class="text-[10px] font-outfit-light content-center">I value word-of-mouth reviews and referrals the most.</div>
                        </div>

                        <div class="bg-midnight/30 rounded-lg flex px-2 lg:px-4 w-full items-center p-2 space-x-2">
                            <div class="text-4xl md:text-6xl text-white opacity-60">04</div>
                            <div class="text-[10px] font-outfit-light content-center">I love being able to move cities every few months.</div>
                        </div>

                        <div class="bg-midnight/30 rounded-lg flex px-2 lg:px-4 w-full items-center p-2 space-x-2">
                            <div class="text-4xl md:text-6xl text-white opacity-60">05</div>
                    ...
                    <div class="flex w-3/4 gap-2 lg:gap-4">
                        <div class="bg-midnight/30 rounded-lg flex px-2 lg:px-4 w-full items-center p-2 space-x-2">
                            <div class="text-4xl md:text-6xl text-white opacity-60">06</div>
                            <div class="text-[10px] font-outfit-light content-center">I believe a different hospital could be a better match for me.</div>
                        </div>

                        <div class="bg-midnight/30 rounded-lg flex px-2 lg:px-4 w-full items-center p-2 space-x-2">
                            <div class="text-4xl md:text-6xl text-white opacity-60">07</div>
