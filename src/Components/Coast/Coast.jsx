...
export default function Coast () {
    ...
    return (
      <div>
    <div className="flex w-full max-w-3xl justify-items-center bg-coast-logo bg-scroll bg-contain bg-top overflow-auto bg-no-repeat">
      <div className="flex flex-col w-3xl h-screen" >
