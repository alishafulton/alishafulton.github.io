...
<div>
 ...
 <div className="flex flex-col w-full  justify-center justify-items-center p-2">
        ...
        <div className="flex flex-col w-full py-2">
            <div className="flex w-auto mx-8 bg-black text-white rounded-lg sm:text-sm lg:text-lg text-center justify-center py-2 px-3 font-coast z-20">Time-Consuming Search Process</div>
