...
export default function Channel () {  
    ...
    return (
      ...
      <div className="flex w-full justify-center bg-navy overflow-hidden">
        ...
        <div className="flex flex-col w-2/3 justify-self-center text-white font-channel space-y-4 py-4 ">
          ...
          <div className="flex flex-col place-content-end">
            ...
            <div className="text-lg text-right w-full place-content-end">To provide a space for healthcare workers to review their environments, and for those reviews to assist healthcare workers who are looking to switch facilities.</div>
        </div>
        </div>
